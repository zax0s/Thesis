...
Multiple histograms from a dynamic dataset can be concatenated together into a single file, before used in \gls{castor} for dynamic reconstruction. In this case reconstructions can be performed using the concatenated file and solely with the framing definition used to created the histograms. 
