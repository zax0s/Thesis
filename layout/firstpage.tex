...
\newcommand{\jurynameA}{Marie Poirier-Quinot}
\newcommand{\juryadressA}{Professeure, Université Paris-Saclay (Laboratoire d’Imagerie Biomédicale Multimodale Paris Saclay, CEA, CNRS, INSERM)}
%\newcommand{\juryroleA}{Président}
\newcommand{\juryroleA}{Examinateur}

%%% Membre n°2 (Rapporteur) / Member n°2 (Reviewer)
\newcommand{\jurynameB}{Denis Mariano Goulart}
\newcommand{\juryadressB}{Professeur, Université de Montpellier (PhyMedExp, INSERM, CNRS)}
\newcommand{\juryroleB}{Rapporteur}

%%% Membre n°3 (Rapporteur) / Member n°3 (Reviewer)
\newcommand{\jurynameC}{Alexandre Bousse}
\newcommand{\juryadressC}{Professeur associé, Université de Bretagne Occidentale (LaTIM, INSERM UMR 1101)}
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{Claude Comtat}
\newcommand{\juryadressE}{Ingénieur de recherche , Université Paris-Saclay (Laboratoire d’Imagerie Biomédicale Multimodale Paris Saclay, CEA, CNRS, INSERM)}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°4 (Examinateur) / Member n°4 (Examiner)
\newcommand{\jurynameD}{Simon Stute}
\newcommand{\juryadressD}{Ingénieur de recherche hospitalier, CHU Nantes, Université d'Angers, Universtité de Nantes (CRCINA, INSERM, CNRS)}
\newcommand{\juryroleD}{Co-encadrant}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Johan Nuyts}
\newcommand{\juryadressF}{Professeur, KU/UZ Leuven (Department of Imaging and Pathology, Division of Nuclear Medicine)}
%\newcommand{\juryroleF}{Co-directeur de thèse}
\newcommand{\juryroleF}{Examinateur}

%%% Membre n°7 (Invité) / Member n°7 (Guest)
\newcommand{\jurynameG}{Fotis Kotasidis}
\newcommand{\juryadressG}{GE Healthcare }
\newcommand{\juryroleG}{Examinateur}

%%% Membre n°8 (Invité) / Member n°8 (Guest)
\newcommand{\jurynameH}{}
\newcommand{\juryadressH}{}
...
\begin{textblock}{10}(5.7,3)
	...
	\begin{flushright}
		...
		préparée à Université Paris-Saclay (Laboratoire d’Imagerie Biomédicale Multimodale Paris Saclay, CEA, CNRS, INSERM) \\ \bigskip
		\vfill
