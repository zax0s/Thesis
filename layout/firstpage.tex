...
\newcommand{\juryadressC}{Maître de conférence, Université de Bretagne Occidentale (LaTIM, INSERM UMR 1101)}
\newcommand{\juryroleC}{Rapporteur}

%%% Membre n°5 (Directeur de thèse) / Member n°5 (Thesis supervisor)
\newcommand{\jurynameE}{Claude Comtat}
\newcommand{\juryadressE}{Ingénieur chercheur, CEA, Laboratoire d’Imagerie Biomédicale Multimodale Paris Saclay, CNRS, INSERM)}
