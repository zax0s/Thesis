...
Due to practical limitations, the simulation study was focused on a single bed position from the assumed DWB protocols of five bed positions.
The second bed position from the patient top was selected for this study, as a compromise between the differences expected from S\&S and CBM protocols and to avoid having to consider further complexity in CBM protocols (ex. overscan at edge position). S\&S and CBM protocols are expected to be less different on the edge locations of the acquisition (1st and 5th bed position) while maxim difference would be expected at the central position. For these reasons, it was deemed optimum to investigate the 2nd bed position of the simulated protocols.
