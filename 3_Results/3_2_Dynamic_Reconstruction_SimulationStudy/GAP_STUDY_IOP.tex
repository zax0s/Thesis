...
Unlike what will be presented in chapter~\ref{Chap3_4:Residual} for multi-bed dynamic reconstruction, in this chapter and for this simulation study we consider the dynamic reconstruction of each bed position separately. The results of these reconstructions could still be used for WB parametric imaging, by post-reconstruction merging of the bed's parametric images. This parametric merging approach was effectively used in chapter~\ref{Chap3_4:Residual}, due to limitations that will be discussed in that chapter by the use of the adaptive reconstruction algorithm.
...
The ability to derive $K_1$ and $K_i$ parametric images for comparison is clinically relevant, as it can reflect differences in the behaviour of early and late kinetics. For example, the use of images of this type for lung tumours has been shown to provide complementary information~\cite{Besson2020}.
...
Results on real data showed similar evolution of CNR with increasing iterations for 4D and 3D reconstructions, in non-TOF and TOF reconstructions respectively.
...
Finally, an open question remaining unanswered is whether a DWB protocol (limited by the delay characteristics of a scanner) could be optimised in a way that it could provide sufficient dynamic information on early kinetics for the reliable estimation of $K_1$ maps over the whole-body. As already mentioned, $K_1$ information can be complementary to $K_i$ and thus of interest to be estimated over the whole body. Furthermore, in pharmacological applications, such as the one presented in chapter~\ref{Chap3_3:IsotoPK}, estimation of $K_1$ over the whole body could be of great interest.
