...
Acquisition of DWB datasets in S\&S mode with overlapping bed positions result in complex datasets of PET RAW data, in relation to timing and positional information. Moreover, the addition of an initial DSB acquisition, conducted for IDIF derivation purposes or for the sampling of fast kinetics to allow for more complex kinetic modeling~\cite{Zaker2020}, increases the complexity of the PET RAW dataset. 
...
This issue has been addressed in the following work by making use of adaptive residual modelling within the dynamic reconstruction. It was presented during the IEEE/MIC-2020 conference for which the following conference record has been prepared. 
