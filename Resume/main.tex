...
\begin{figure} [ht!]
\centering
\includegraphics[scale=0.45,angle=0]{3_1_Macaque_PET.pdf}
...
\begin{figure} [ht!]
\centering
\includegraphics[scale=0.45,angle=0]{3_5_tumour_Lung_NoTOF.pdf}
...
\begin{figure} [h!]
\centering
\includegraphics[scale=0.28,angle=0]{3_5_RealDataExample.png}
...
Les résultats de l'analyse VOI, donnés dans la figure~\ref{fig_3_3:IsotoPK_CTRL_DWB_4D_vs_3D_Central} pour le scan \textit{CTRL}, ont montré une bonne concordance des TAC entre la reconstruction 3D et spectrale 4D. Les images paramétriques de $K_1^{*}$ issues de la reconstruction spectrale 4D sont présentées dans la figure~\ref{fig_3_3:IsotoPK_K1_SingleSlice} pour les scans du même sujet, avec et sans injection de l'inhibiteur.
%
\begin{figure} [h!]
\centering
\includegraphics[scale=0.5,angle=0]{3_3_IsotoPK_CTRL_DWB_3D_vs_4D_central.pdf}
...
\begin{figure} [h!]
\centering
\includegraphics[scale=0.5,angle=0]{3_3_IsotoPK_K1_SingleSlice.pdf}
